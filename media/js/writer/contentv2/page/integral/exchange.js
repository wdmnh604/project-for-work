...
(function($) {
    ...
    var _hardworkExchangeListTpl = [
        '<%each list as item index%>',
            '<dd>',
                '<b><%=parseInt(item.date.toString().substr(4))%>月</b>',
    ...
    var _ajaxUrls = {
        //全勤请假条
        'fullTime' : {
            'getBook' : "/Contentv2/IntegralExchange/fullTimeNovelList.html", //获取小说下拉列表
            'getExchangeInfo' : "/Contentv2/IntegralExchange/fullTimeParam.html", //获取兑换的相关信息
            'submitExchange' : "/Contentv2/IntegralExchange/fullTimeExchange.html" //兑换
        },
        //创作保障请假条
        'safeguard' : {
            'getBook' : "/Contentv2/IntegralExchange/safeguardNovelList.html",
            'getExchangeInfo' : "/Contentv2/IntegralExchange/safeguardParam.html",
            'submitExchange' : "/Contentv2/IntegralExchange/safeguardExchange.html"
        },
        //勤奋写作豁免权
        'hardwork' : {
            'getBook' : "/Contentv2/IntegralExchange/diligenceNovelList.html",
            'getExchangeInfo' : "/Contentv2/IntegralExchange/diligenceParam.html",
            'submitExchange' : "/Contentv2/IntegralExchange/diligenceExchange.html"
        }
    };
