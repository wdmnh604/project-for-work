...
(function($) {
    ...
    var _ajaxUrls = {
        'getRecord' : "/Content/IntegralExchange/getExchange.html",//获取积分的记录                                     
        'useRecord' : "/Content/IntegralExchange/lostExchange.html"//消耗积分的记录
    };
        ...
        _util.request({
            ...
            success: function(json) {
                ...
                if(json.status && json.data){
                    ...
                    _renderRecord(type, json.data.list, json.data.pageCount);
                }else{
     ...
     */
    function _renderRecord(type, list, pageCount){
        if(!type){
            return;
        }
