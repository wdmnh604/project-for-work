...
(function($) {
    ...
    var _ajaxUrls = {
        'checkAuthorName': '/Contentv2/Public/ajaxCheckAuthorNameExist.html' //检测笔名是否存在
    };
    ...
    function init(cityList) {
        ...
        _areaLinkage.regionalLinkage(_params.cityList);
    ...
    function showDefaultCopy(){
        ...
        $address.blur(function(){
            if($address.val() == ''){
                ...
                $address.attr('style','').attr('style',_blackColor);
            }
        });
